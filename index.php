        ...
        <div class="row">
          <div class="col-1-of-2">
            ...
            <p class="paragraph">
              ...
              explicabo natus eius expedita deserunt itaque eligendi voluptatem
              aspernatur eum dolor numquam aut minus doloribus nihil vitae odio
              officia vero!
            </p>
            <h3 class="heading-tertiary u-margin-bottom-small">
          ...
          <div class="story">
            <figure class="story__shape">
              <img
                ...
                class="story__img"
              />
              <figcaption class="story__caption">Jake Wilson</figcaption>
            </figure>
            <div class="story__text">
              <h3 class="heading-tertiary u-margin-bottom-small">
